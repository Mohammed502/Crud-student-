...
public class StudentController {
    ...
    public ResponseEntity<String> saveStudent(@RequestBody Student student){
       ...
       return new ResponseEntity<String>("Student Created with "+id+" has been saved", HttpStatus.OK);
    }
...
@PutMapping("/updateStudent/{sno}")
    public ResponseEntity<String> updateStudent(@PathVariable("sno") Integer sno, @RequestBody Student student){
      ...
      return new ResponseEntity<String>("Student with "+id+" updated successfully",HttpStatus.OK);
    }
